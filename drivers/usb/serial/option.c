...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(ALINK_VENDOR_ID, 0x9000), .driver_info = RSVD(5) },
	{ USB_DEVICE(ALINK_VENDOR_ID, ALINK_PRODUCT_PH300) },
	{ USB_DEVICE_AND_INTERFACE_INFO(ALINK_VENDOR_ID, ALINK_PRODUCT_3GU, 0xff, 0xff, 0xff) },

	/* SIMCom SIM7500/SIM7600 */
	{ USB_DEVICE(ALINK_VENDOR_ID, 0x9001),
	  .driver_info = RSVD(5) | RSVD(6) },
	{ USB_DEVICE(ALINK_VENDOR_ID, 0x9002),
	  .driver_info = RSVD(5) | RSVD(6) },
	{ USB_DEVICE(ALINK_VENDOR_ID, 0x9004),
	  .driver_info = RSVD(6) | RSVD(7) },
	{ USB_DEVICE(ALINK_VENDOR_ID, 0x9006),
	  .driver_info = RSVD(4) },
	{ USB_DEVICE(ALINK_VENDOR_ID, 0x9007),
	  .driver_info = RSVD(5) | RSVD(6) | RSVD(7) },
	{ USB_DEVICE(ALINK_VENDOR_ID, 0x901A),
	  .driver_info = RSVD(3) | RSVD(4) },
	{ USB_DEVICE(ALINK_VENDOR_ID, 0x901B),
	  .driver_info = RSVD(2) | RSVD(3) },
	{ USB_DEVICE(ALINK_VENDOR_ID, 0x9024),
	  .driver_info = RSVD(2) },
	{ USB_DEVICE(ALINK_VENDOR_ID, 0x902A),
	  .driver_info = RSVD(1) },
	{ USB_DEVICE_INTERFACE_CLASS(ALINK_VENDOR_ID, 0x9003, 0xff),
	  .driver_info = RSVD(7) },
	{ USB_DEVICE_INTERFACE_CLASS(ALINK_VENDOR_ID, 0x9005, 0xff),
	  .driver_info = RSVD(8) },
	{ USB_DEVICE_INTERFACE_CLASS(ALINK_VENDOR_ID, 0x9011, 0xff),
	  .driver_info = RSVD(7) },
	{ USB_DEVICE_INTERFACE_CLASS(ALINK_VENDOR_ID, 0x9018, 0xff),
	  .driver_info = RSVD(7) },
